            ...
            <div class="pt-4 flex flex-wrap justify-between items-center gap-4">
                ...
                <form method="GET" action="{{ route('admin.job_offers.index') }}" class="w-full md:w-1/3">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="keyword" id="default-search" class="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="キーワードで検索">
